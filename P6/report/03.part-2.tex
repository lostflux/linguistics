      ...
      % \begin{minipage}[width=0.6\textwidth]
        \begin{algorithm}[H]
          ...
          \begin{algorithmic}[1]
            ...
            \State
            \State kigo\_words $\gets$ \textsc{get\_kigo\_words}() \Comment{All possible kigo words}
            \State kireji\_words $\gets$ \textsc{get\_kireji\_words}() \Comment{All possible kireji words}
